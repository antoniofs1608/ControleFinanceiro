...
{
    /// <inheritdoc />
    public partial class ControleFinanceiro_001 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Foto = table.Column<byte[]>(type: "RAW(2000)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "758cb219-659a-4c15-9c55-eb2306961145", null, "Administrador do sistema", "Administrador", "ADMINISTRADOR" },
                    { "9fe7ff08-bba0-4bcd-9fdc-b4dc1e964bd6", null, "Usuário do sistema", "Usuario", "USUARIO" }
                });
