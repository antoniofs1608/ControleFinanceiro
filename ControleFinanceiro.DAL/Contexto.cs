...
namespace ControleFinanceiro.DAL
{
    ...
    {
        // vamos criar nossos DBSet onde teremos todas nossas ações (inclusão, exclusão, alteração, consulta, etc) 
        // a serem realizadas por exemplo quando precisar usar Cartoes eu crio uma variável do tipo Contexto e basta
        // colocar Contexto.Cartoes
